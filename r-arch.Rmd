---
title: "Who is using R in archaeology...and for what?"
...
The dataset used in this analysis was harvested from [Scopus](https://www.elsevier.com/solutions/scopus), includes all articles published containing citations to R in the references AND _archaeology_ in the title, abtract, or keywords, and was analysed using the `bibliometrix` package [@RN20997].
